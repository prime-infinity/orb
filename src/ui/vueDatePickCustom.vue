<template>
    <div class="vdpComponent" style="display:block;" :class="{vdpWithInput: hasInputElement}">
        <slot
            :open="open"
            :close="close"
            :toggle="toggle"
    ...
    methods: {
        ...
        formatSimpleDateToString(date, dateFormat) {
            ...
            return dateFormat
                ...
                //.replace(AMPMClockRE, match => isPM(date.getHours()) ? 'PM' : 'AM') //also here
            ;
