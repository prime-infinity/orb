<template>
  <div>
    ...
    >
      <div
        class="spinner-border text-danger mt-5"
      ...
      <div v-if="!hasOrganProfile">
        <div class="mt-5 pt-5">
          <div class="mt-5 jumbotron">
            ...
            <div @click="createOrganProfile" class="btn customInputButton">
              here
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    createOrganProfile: function() {
      ...
      this.$http
        .post(this.backendhost + "/organProfile", organProfileCreatingData)
        .then(() => {
