<template>
    ...
    <div >
        ...
        <div v-if="!isLoadingOrganProfile" class="d-flex justify-content-center mt-5 pt-5">
            ...
            <div v-if="!hasOrganProfile">
                <div class="mt-5 pt-5">
                    <div class="mt-5 jumbotron">
                        create organiser profile to be able to host events
                        <div @click="createOrganProfile" class="btn customInputButton">here </div>
                    </div>
                </div>
            </div>
            ...
            <div v-if="hasOrganProfile" class="row mt-1 pt-5 justify-content-center">
                <div class="col-11 col-md-8 col-lg-6">
                    ...
                    <div class="form-input mb-5">
                        ...
                        <div class=" mb-4">
                            <label for="organiserName" class="font-weight-bold">Organiser Name</label>
                            <input v-model="organisersProfile[0].organ_name" :placeholder="`${organisersProfile[0].organ_name}`" type="text" class="form-control customInput" id="organiserName">
                            <small v-if="errors.name" class="text-danger">{{ errors.name[0] }}</small>
                        </div>

                        <div class="mb-4">
                            <label for="organiserName" class="font-weight-bold">Short Description</label>
                            <textarea v-model="organisersProfile[0].organ_desc" :placeholder="`${organisersProfile[0].organ_desc}`" class="form-control customInput" id="organiserName" cols="30" rows="10"></textarea>
                        ...
                        <div class="form-row">
                            <div class="form-group col-12 col-md-6">
                                <label for="organiserNum" class="font-weight-bold">Phone Number</label>
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                    <div class="input-group-text" id="theAt">+234</div>
                                    </div>
                                    <input v-model="organisersProfile[0].organ_num" :placeholder="`${organisersProfile[0].organ_num}`" type="text" class="form-control customInput" id="organiserNum">
                                </div>
                                <small v-if="errors.number" class="text-danger">{{ errors.number[0] }}</small>
                            </div>

                            <div class="form-group col-12 col-md-6 ">
                                <label for="organiserMail" class="font-weight-bold">Email address</label>
                                <input v-model="organisersProfile[0].organ_email" :placeholder="`${organisersProfile[0].organ_email}`" type="email" class="form-control customInput" id="organiserMail" aria-describedby="emailHelp">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-12 col-md-6 ">
                                <label for="organiserInsta" class="font-weight-bold">Instagram</label>
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                    <div class="input-group-text" id="theAt">@</div>
                                    </div>
                                    <input v-model="organisersProfile[0].organ_insta" :placeholder="`${organisersProfile[0].organ_insta}`" type="text" class="form-control customInput" id="organiserInsta">
                            ...
                            <div class="form-group col-12 col-md-6  mb-5">
                                <label for="organiserTwitter" class="font-weight-bold">Twitter</label>
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                    <div class="input-group-text" id="theAt">@</div>
                                    </div>
                                    <input v-model="organisersProfile[0].organ_twitter" :placeholder="`${organisersProfile[0].organ_twitter}`" type="text" class="form-control customInput" id="organiserTwitter">
                                    
                                </div>
                                <small v-if="errors.twitter" class="text-danger">{{ errors.twitter[0] }}</small>
                            </div>
                    ...
                    <div class="form-button row justify-content-center fixed-bottom bg-white shadow-sm">
                        <div class="col-10 col-lg-6 col-md-8 col-sm-8 mt-1 mb-1">
                            <button :disabled="savingOrganInfo" type="submit" class="btn customInputButton">
                                <div @click="saveOrganInfo" v-show="!savingOrganInfo">Save</div>
                                <span v-show="savingOrganInfo" class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                            </button>
                        </div>
                    </div>
