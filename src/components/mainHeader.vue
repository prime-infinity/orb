<template>
    <div>
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark pt-2 pb-2 pl-4">
            ...
            <transition enter-active-class="animate__animated animate__bounceIn" leave-active-class="animate__animated animate__bounceOut">
                <button v-if="$route.path !== '/organiserprofile'" class="navbar-toggler" @click="toggleMobileMenu">
                    <span class="navbar-toggler-icon"></span>
                </button>
            </transition>


            <!-- the email dropdown that shows when in organiserprofile -->
            <ul v-if="$route.path === '/organiserprofile'" class="navbar-nav  ml-auto" >
                <li v-if="user !== null" class="nav-item dropdown ">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle px-3" data-toggle="collapse" data-target="#organProfile">
                        {{ user.email }}
                    </a>

                    <div class="dropdown-menu dropdown-menu-right" id="organProfile">
                        <router-link to="/">
            ...
            <div id="menuFloat" class="d-none fixed-top" :class="[mobileMenu ? 'animate__animated animate__bounceInLeft d-block':'', ]">
                ...
                <!-- if in organiserprofile -->
                <div v-if="$route.path === '/organiserprofile'" class="col-12 text-left font-weight-bold">
                    <ul class="navbar-nav ml-auto">
                        <li v-if="user !== null" class="nav-item mt-4 pt-2">
                            <router-link to=""><a class="nav-link text-dark" href="#">Events</a></router-link>
                        </li>
                        <li v-if="user !== null" class="nav-item mt-4 pt-2">
                            <router-link to=""><a class="nav-link text-dark" href="#">Payouts</a></router-link>
                        </li>
                        <li v-if="user !== null" class="nav-item mt-4 pt-2">
                            <router-link to=""><a class="nav-link text-dark" href="#">Help & FAQ</a></router-link>
                        </li>
                        <li v-if="user !== null" class="nav-item mt-4 pt-2">
                            <router-link to=""><a class="nav-link text-dark" href="#">Settings</a></router-link>
                        </li>
                    </ul>
                </div>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li v-if="user !== null" class="nav-item dropdown">
                        ...
                        <li class="nav-item mt-4 mt-md-0 pt-2">
                            <button @click="createEvent" class="btn orbButton">Create events</button>
                        </li>
